...
var PostItBrowseComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PostItBrowseComponent, _super);
    function PostItBrowseComponent(router, service) {
        var _this = _super.call(this) || this;
        _this.router = router;
        _this.service = service;
        return _this;
    }
    PostItBrowseComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getAll()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
            .subscribe(function (x) { return _this.notes = x; });
    };
    PostItBrowseComponent.prototype.onAdd = function () {
        var _this = this;
        this.service.create()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
            ...
            if (!resp) {
                ...
                _this.router.navigateByUrl("/" + resp.id);
            }
        });
    };
    PostItBrowseComponent.ctorParameters = function () { return [
...
var PostItEditComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PostItEditComponent, _super);
    function PostItEditComponent(service, route, router) {
        var _this = _super.call(this) || this;
        _this.service = service;
        _this.route = route;
        _this.router = router;
    ...
    PostItEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        if (isNaN(id)) {
            ...
            this.service.get(Number.parseInt(id))
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (p) {
                if (!p)
                    _this.backToMainView(); // back to main view if no record found
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
                .subscribe(function (p) { return _this.postItNote = p; });
        }
    };
    PostItEditComponent.prototype.backToMainView = function () {
        this.router.navigateByUrl('/');
    };
    PostItEditComponent.prototype.onDelete = function () {
        var _this = this;
        this.service.delete(this.postItNote.id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
            .subscribe(function (_) { return _this.backToMainView(); });
    };
    PostItEditComponent.prototype.onSave = function () {
        var _this = this;
        this.service.save(this.postItNote)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$))
            .subscribe(function (resp) {
            if (resp) {
                _this.backToMainView();
            }
            else {
                alert("Ups. Something went wrong!");
            }
    ...
    PostItEditComponent.ctorParameters = function () { return [
        { type: src_app_services_post_it_service__WEBPACK_IMPORTED_MODULE_5__["PostItService"] },
...
var SingleNoteComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SingleNoteComponent, _super);
    function SingleNoteComponent(router) {
        var _this = _super.call(this) || this;
        _this.router = router;
        _this.onEditing = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        return _this;
    }
    SingleNoteComponent.prototype.ngOnInit = function () {
    };
    SingleNoteComponent.prototype.onDoubleClick = function () {
        if (!this.singleNoteView) {
            this.router.navigateByUrl("/" + this.postItNote.id);
        }
    };
    SingleNoteComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var PostItRepo = /** @class */ (function () {
    function PostItRepo(http) {
        this.http = http;
    }
    PostItRepo.prototype.create = function () {
        return this.http.post(_util_api__WEBPACK_IMPORTED_MODULE_3__["api"].postIt.create, {}, { observe: 'response' });
    };
    PostItRepo.prototype.getAll = function () {
...
var PostItService = /** @class */ (function () {
    function PostItService(repo) {
        this.repo = repo;
    }
    PostItService.prototype.create = function () {
        return this.repo.create()
            ...
            if (resp.status != _util_http_status_enum__WEBPACK_IMPORTED_MODULE_4__["HttpStatus"].OK)
                console.log(resp);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (resp) { return resp.body; }));
    };
    PostItService.prototype.getAll = function () {
        return this.repo.getAll()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (resp) {
            if (resp.status != _util_http_status_enum__WEBPACK_IMPORTED_MODULE_4__["HttpStatus"].OK)
                console.log(resp);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (resp) { return resp.body; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (page) { return page.content; }));
    };
    PostItService.prototype.get = function (id) {
    ...
    PostItService.prototype.delete = function (id) {
    ...
    PostItService.prototype.save = function (dto) {
    ...
    PostItService.ctorParameters = function () { return [
...
var apiBuilder = function (obj, prefix) {
    prefix += obj.url || '';
